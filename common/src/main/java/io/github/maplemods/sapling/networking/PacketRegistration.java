...
public class PacketRegistration {
	...
	private void initClientPackets() {
		Network
				...
				.registerPacket(ToClientSyncAllEntityTexturesPacket.type(), ToClientSyncAllEntityTexturesPacket.class, ToClientSyncAllEntityTexturesPacket.STREAM_CODEC, ToClientSyncAllEntityTexturesPacket::handle);
	}
